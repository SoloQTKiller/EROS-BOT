...
module.exports.run= async (bot,message,args)=>{
    ...
    if(!message.member.hasPermission("ADMINISTRATOR")) return message.reply("você não tem permissão de usar esse comando")
                            ...
                            collector.on('collect',sobre=>{
                                ...
                                if(sobre.content.length > 0){
                                    ...
                                    let embed = new Discord.RichEmbed()
                                                ...
                                                message.channel.send(`Anúncio ${save._nome} feito estou enviando a mensagem para todos os membros!\nPara apagar o anúncio do meu banco de daos use e!anuncio \`${save._nome}\`!`)
                                    /*
